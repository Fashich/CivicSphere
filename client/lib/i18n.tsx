...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    leaveWithMessage: "Leave with Message",
    leaveImmediately: "Leave Immediately",
    leaveCommunityTitle: "Leave Community",
    leaveCommunityDesc: "Would you like to leave a message before leaving?",
    farewell: "Farewell Message",
    farewellPlaceholder: "Share your thoughts or say goodbye...",
    confirmLeave: "Confirm Leave",
    announcement: "Announcement",
    postAnnouncement: "Post Announcement",
    announcementTitle: "Post Announcement",
    ...
    joinCommunityDesc: "You are about to join this community.",
    confirmJoin: "Join Now",
  ...
  id: {
    ...
    requestToJoin: "Ajukan Bergabung",
    closed: "Tertutup",
    leave: "Keluar Komunitas",
    leaveWithMessage: "Keluar dengan Pesan",
    leaveImmediately: "Keluar Langsung",
    leaveCommunityTitle: "Keluar Komunitas",
    leaveCommunityDesc: "Apakah Anda ingin meninggalkan pesan sebelum keluar?",
    farewell: "Pesan Perpisahan",
    farewellPlaceholder: "Bagikan pikiran Anda atau ucapkan selamat tinggal...",
    confirmLeave: "Konfirmasi Keluar",
    announcement: "Pengumuman",
    postAnnouncement: "Posting Pengumuman",
    announcementTitle: "Posting Pengumuman",
    ...
    joinCommunityDesc: "Anda akan bergabung dengan komunitas ini.",
    confirmJoin: "Bergabung Sekarang",
    leaderOnly: "Hanya pemimpin",
    blog: "Blog",
    legal: "Legal",
    privacy: "Privasi",
    terms: "Syarat",
